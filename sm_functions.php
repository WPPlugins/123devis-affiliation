<?php
	...
	*/
	...
	function sm_head_embedeableforms_js_json(){
		...
		print '<script> var sm_categories = ' . json_encode($categories) . '</script>';
		print '<script> var sm_interviews = ' . json_encode($interviews) . '</script>';
		print '<script> var sm_shortcodes = ' . json_encode($shortcodes) . '</script>';
		print '<script> var sm_translate  = ' . json_encode(array(
